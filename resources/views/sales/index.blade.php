    ...
    <div class="flex flex-col min-h-screen">
        <div class="relative w-full px-2 pb-10 bg-sekunder h-fit">
            <div class="flex items-center justify-between px-2 py-2 h-fit">
                <span
                    class="absolute inset-x-0 inline-block w-full text-3xl text-center text-white select-none font-batik">Sales</span>
        ...
        <div class="z-20 flex flex-col w-full h-full px-6 py-4 -mt-6 bg-white rounded-t-3xl grow">
            <form action="{{ route('sales.store') }}" method="post" class="flex flex-col gap-y-6">
                ...
                <select name="jenis" id="jenis"
                    class="w-full py-2 font-bold border-2 rounded border-sekunder outline-2 outline-sekunder focus:border-teal-800 focus:ring-teal-800"
                    required>
                ...
                @enderror
                <div
                    class="w-full px-3 py-2 font-bold border-2 rounded border-sekunder outline-2 outline-sekunder focus:border-teal-800 focus:ring-teal-800">
                ...
                <div class="">
                    <input type="number" name="msisdn" id="msisdn" placeholder="Nomor MSISDN"
                        class="w-full px-3 py-2 font-bold border-2 rounded border-sekunder placeholder:font-normal outline-2 outline-sekunder focus:border-teal-800 focus:ring-teal-800"
                        required>
                ...
                <button type="submit"
                    class="inline-block w-full px-4 py-2 mx-auto mt-auto text-xl font-bold text-center text-white transition-all rounded bg-sekunder hover:no-underline hover:bg-teal-800">Submit</button>
            </form>
        </div>
    </div>
    @if (session('success'))
