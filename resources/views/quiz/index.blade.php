...
<div class="flex flex-col min-h-screen">
    <div class="relative w-full px-2 pb-10 bg-orange-600 h-fit">
        <div class="flex items-center justify-between px-2 py-2 h-fit">
            <span class="absolute inset-x-0 inline-block w-full text-3xl text-center text-white select-none font-batik">Quiz</span>
            <a href="{{ URL::to('/') }}" class="z-10 flex items-center h-fit w-fit"><i class="text-xl text-white fa-solid fa-house"></i></a>
            <a href="{{ URL::to('/profile') }}" class="z-10 flex items-center p-3 rounded-full shadow h-fit w-fit bg-slate-50"><i class="text-orange-600 fa-solid fa-user"></i></a>
        </div>
    </div>
    <div class="z-20 flex flex-col w-full h-full px-6 py-2 -mt-6 bg-white rounded-t-3xl grow">
        ...
        <form action="{{ route('quiz.answer.store') }}" method="post" id="form-quiz">
            ...
            @endforeach
            <button type="submit" id="btn-submit" class="w-full px-6 py-2 my-4 font-semibold text-white bg-orange-600 rounded">Selesai</button>
        </form>
        ...
        <div class="my-8">
            ...
            <table class="mx-auto overflow-auto text-left border border-collapse w-fit">
                <thead class="border-b">
                    <tr>
                        <th class="p-2 text-sm font-medium text-gray-100 uppercase bg-orange-600">Tanggal</th>
                        <th class="p-2 text-sm font-medium text-gray-100 uppercase bg-orange-600">Nama Quiz</th>
                        <th class="p-2 text-sm font-medium text-gray-100 uppercase bg-orange-600">Hasil</th>
                    </tr>
                </thead>
