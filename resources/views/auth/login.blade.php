@extends('layouts.app')
@section('content')
<div class="flex flex-col items-center h-screen px-4 bg-white">
    <div class="bg-premier rounded-md shadow-xl w-full flex flex-col items-center shadow-[#aeaeae] my-auto py-4 px-4">
        ...
        <a href="{{ route('akun.aktivasi') }}" class="inline-block mt-4 text-center text-white underline">Aktivasi Akun</a>
    </div>
</div>
@endsection
